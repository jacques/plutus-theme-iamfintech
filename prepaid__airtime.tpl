...
{/foreach}
      ...
      <p>
        You can lookup the token for a transaction on your transaction view of your DEMO Account.
      </p>
...
<!--
      <p>
        Not sure which mobile network a cellphone number is on?
      </p>
-->
    </div>
